...
export class DatatableComponent implements OnInit {
    ...
    onClickTable = function ($event) {
        ...
        this.previousSelectedRow.style.backgroundColor = null;

        this.currentSelected = $event.srcElement.parentElement
        this.currentSelected.style.backgroundColor = "lightblue";

        this.previousSelectedRow = this.currentSelected;

        this.onRowClick.emit(this.currentSelected);
    }
}
